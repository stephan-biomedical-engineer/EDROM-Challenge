...
```
- Implementa uma heurística híbrida baseada em Chebyshev
- Reflete melhor os custos reais quando diagonais são permitidas
...
```
- Movimentos retos: custo 300
- Movimentos diagonais: custo 100
- Com bola: custo multiplicado por 1.5
